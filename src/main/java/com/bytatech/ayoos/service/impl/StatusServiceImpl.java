...
import com.bytatech.ayoos.repository.StatusRepository;
import com.bytatech.ayoos.repository.search.StatusSearchRepository;
import com.bytatech.ayoos.service.dto.StatusDTO;
import com.bytatech.ayoos.service.mapper.StatusMapper;
...
public class StatusServiceImpl implements StatusService {
     ...
     *
     * @param query the query of the searchc
     * @param pageable the pagination information
     * @return the list of entities
     */
    @Override
	...
	/* (non-Javadoc)
	 * @see com.bytatech.ayoos.service.StatusService#findByReservedSlotId(java.lang.Long)
	 */
	@Override
	public StatusDTO findByReservedSlotId(Long id) {
		return statusMapper.toDto(statusRepository.findByReservedSlotId(id));
	}
}
